      ...
      if (redeemPrice <= pointsCollected) {
        switch (redeemPrice) {
          case "50":
            ...
            break;
          case "60":
            localStorage.setItem("ticket5", ticketplace);
            break;
          case "100":
          ...
          case "120":
            ...
            break;
          case "130":
            localStorage.setItem("ticket6", ticketplace);
            break;
          case "150":
...
const tickets = [
  ...
  localStorage.getItem("ticket5"),
  localStorage.getItem("ticket6"),
];
ticketsCounter = 0;
